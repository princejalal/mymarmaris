        ...
        <div class="webtop">
            <div class="container">
                <div class="d-flex justify-content-around align-items-center">
                    ...
                    <div class="d-flex p-2 border-left">
                        <a href="tel:{{ check_property($phone,'contact_value') }}" class="h5">
                            <i class="fas fa-phone"></i>
                            {{ check_property($phone,'contact_value') }}
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="webtop-2">
            ...
            <div class="d-flex justify-content-around align-items-center flex-column flex-sm-row">
                ...
                <div class="d-none d-sm-inline-block order-1 order-sm-3">
                    ...
                    <div class="tpon">
                        <a
                            href="tel:{{ check_property($phone,'contact_value') }}">{{ check_property($phone,'contact_value') }}</a>
                    </div>
