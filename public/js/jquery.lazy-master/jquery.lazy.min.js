...
function etiketle() {
    $(SeciliEtiket + " li").length > 1 && ($(SeciliEtiket + " li:gt(0)").hide(), $(SeciliEtiket).css("display", "block"), $(SeciliEtiket + " li:first-child").hide().next("li").show().end().appendTo(SeciliEtiket));
    $(SeciliEtiket + " li").length == 1 && ($(SeciliEtiket + " li:gt(0)").show().appendTo(SeciliEtiket), $(SeciliEtiket).css("display", "block"))
}
...
function resimDegistir() {
    ...
    n = $("#" + this.id).find("input:hidden");
    try {
        SeciliResim = "#" + $("#" + this.id).find(".gif").attr("id");
        t = $(SeciliResim).attr("src");
        $(SeciliResim).attr("src", n.val());
        n.val(t)
    } catch (i) {
    }
    etiketle();
...
var myInterval, SeciliCard, SeciliEtiket, SeciliResim;
...
$(window).on("load resize", function () {
    $(this).width() > 576 ? $(".mycard").hover(resimDegistir, eskiresim) : $(function () {
        $(".lazy").Lazy()
    })
})
$(function () {
